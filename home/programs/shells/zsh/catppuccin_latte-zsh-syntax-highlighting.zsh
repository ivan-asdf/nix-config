...
# modified: +bold
ZSH_HIGHLIGHT_STYLES[single-quoted-argument-unclosed]='fg=#e64553,bold'
ZSH_HIGHLIGHT_STYLES[double-quoted-argument]='fg=#df8e1d'
# modified: +bold
ZSH_HIGHLIGHT_STYLES[double-quoted-argument-unclosed]='fg=#e64553,bold'
ZSH_HIGHLIGHT_STYLES[rc-quote]='fg=#df8e1d'
## Variables
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument]='fg=#4c4f69'
# modified: +bold
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument-unclosed]='fg=#e64553,bold'
...
# modified: +bold
ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=#e64553,bold'
